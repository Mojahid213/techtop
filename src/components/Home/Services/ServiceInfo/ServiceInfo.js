...
const ServiceInfo = ({ details }) => {
    ...
    return (
        <div className="flex flex-1 flex-col border-2 border-gray-800 px-3 py-2 h-full shadow-lg transform sm:transform-gpu hover:scale-105 transition duration-500 ease-in-out">
